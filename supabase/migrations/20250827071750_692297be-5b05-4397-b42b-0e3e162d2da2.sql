...
-- Add constraint to limit family members to 5 per account
ALTER TABLE public.family_members 
ADD CONSTRAINT max_family_members_per_account 
CHECK (
  (SELECT COUNT(*) FROM public.family_members WHERE account_owner_id = account_owner_id AND is_active = true) <= 5
);
